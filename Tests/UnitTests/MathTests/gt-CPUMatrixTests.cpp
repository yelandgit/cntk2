...
class CPUMatrixTests : public ::testing::Test
{
public:
...
///TEST_F(CPUMatrixTests, ConstructorNoFlags)
///{
///	CPUDoubleMatrix m;
...
///	ASSERT_EQ(m(1, 2), 2);
///
///	CPUDoubleMatrix m1(m);
///	ASSERT_TRUE(m1.IsEqualTo(m));
///}
///
///TEST_F(CPUMatrixTests, CharConstructorNoFlags)
///{
///	CPUMatrix<char> m;
///	ASSERT_TRUE(m.IsEmpty());
///
...
///}
///
///TEST_F(CPUMatrixTests, ShortConstructorNoFlags)
///{
///	CPUMatrix<short> m;
///	ASSERT_TRUE(m.IsEmpty());
///
...
///}
///
///TEST_F(CPUMatrixTests, ConstructorFlagNormal)
///{
///	std::array<float, 6> array = {1, 2, 3, 4, 5, 6};
///	CPUSingleMatrix m(2, 3, array.data(), matrixFlagNone);
///	ASSERT_EQ(m(0, 0), 1);
///	ASSERT_EQ(m(0, 1), 3);
///	ASSERT_EQ(m(0, 2), 5);
///	ASSERT_EQ(m(1, 0), 2);
...
///}
///
///TEST_F(CPUMatrixTests, ConstructorFormatRowMajor)
///{
///	std::array<double, 6> array = {7, 8, 9, 10, 11, 12};
///	CPUDoubleMatrix m(2, 3, array.data(), matrixFormatRowMajor);
///	ASSERT_EQ(m(0, 0), 7);
///	ASSERT_EQ(m(0, 1), 8);
///	ASSERT_EQ(m(0, 2), 9);
///	ASSERT_EQ(m(1, 0), 10);
...
///}
///
///TEST_F(CPUMatrixTests, AddAndSub)
///{
...
///	m2(1, 2) = 22;
///
///	CPUDoubleMatrix mC(2, 1);
///	mC(0, 0) = 10;
///	mC(1, 0) = 10;
///
///	CPUDoubleMatrix mR(1, 3);
///	mR(0, 0) = 10;
///	mR(0, 1) = 10;
///	mR(0, 2) = 10;
///
///	CPUDoubleMatrix mS(1, 1);
///	mS(0, 0) = 10;
///
///	CPUDoubleMatrix m3 = m2 - m0;
...
///}
///
///TEST_F(CPUMatrixTests, BatchMatMul)
///{
///	CPUDoubleMatrix m0(6, 2);
///	m0(0, 0) = 1;
///	m0(0, 1) = 2;
///	m0(1, 0) = 3;
///	m0(1, 1) = 4;
...
///	m0(5, 1) = 12;
///
///	CPUDoubleMatrix m1(2, 2);
///	m1(0, 0) = 10;
///	m1(0, 1) = 20;
///	m1(1, 0) = 30;
///	m1(1, 1) = 40;
///
///	CPUDoubleMatrix m00(3, 2);
///	m00(0, 0) = 220;
///	m00(0, 1) = 360;
///	m00(1, 0) = 300;
///	m00(1, 1) = 480;
...
///	m00(2, 1) = 600;
///
///	CPUDoubleMatrix m2(3, 2);
///	CPUDoubleMatrix::BatchMatMul(0.0, m0, false, 3, m1, false, 1, m2, true);
///	ASSERT_TRUE(m2.IsEqualTo(m00));
///}
///
///TEST_F(CPUMatrixTests, MultiplyAndDiv)
///{
///	CPUDoubleMatrix m0(2, 3);
///	m0(0, 0) = 1;
///	m0(0, 1) = 2;
...
///	m1(2, 1) = 16;
///
///	CPUDoubleMatrix m2(2, 2);
///	m2(0, 0) = 75;
///	m2(0, 1) = 89;
///	m2(1, 0) = 186;
///	m2(1, 1) = 221;
///
///	CPUDoubleMatrix m3 = m0 * m1;
///	ASSERT_TRUE(m3.IsEqualTo(m2));
///
///	m3 = m0 * 10;
...
///	ASSERT_TRUE(m3.IsEqualTo(m0));
///
///	CPUDoubleMatrix::MultiplyAndWeightedAdd(1, m0, false, m1, false, 0, m3);
///	ASSERT_TRUE(m3.IsEqualTo(m2));
///
///	m1.Reshape(2, 3);
///	CPUDoubleMatrix::MultiplyAndWeightedAdd(1, m0, false, m1, true, 0, m3);
///	m2(0, 0) = 74;
///	m2(0, 1) = 92;
///	m2(1, 0) = 182;
///	m2(1, 1) = 227;
///	ASSERT_TRUE(m3.IsEqualTo(m2));
///
///	CPUDoubleMatrix::MultiplyAndWeightedAdd(10, m0, false, m1, true, 2, m3);
///	m2(0, 0) = 888;
///	m2(0, 1) = 1104;
///	m2(1, 0) = 2184;
///	m2(1, 1) = 2724;
///	ASSERT_TRUE(m3.IsEqualTo(m2));
///
///	CPUDoubleMatrix::MultiplyAndWeightedAdd(1, m0, true, m1, false, 0, m3);
///	m2.Resize(3, 3);
///	m2(0, 0) = 67;
///	m2(0, 1) = 72;
///	m2(0, 2) = 77;
...
///
///	CPUDoubleMatrix m_Cos(2, 3);
///	m_Cos.SetValue(m_Trig);
///
///	CPUDoubleMatrix m_Cos_expected(2, 3);
...
///	ASSERT_TRUE(m_Cos.IsEqualTo(m_Cos_expected, c_epsilonFloatE4));
///
///	CPUDoubleMatrix m_NegSine(2, 3);
///	m_NegSine.SetValue(m_Trig);
///
///	CPUDoubleMatrix m_NegSine_expected(2, 3);
...
///	m0(1, 2) = 6;
///
///	CPUDoubleMatrix mResult;
///	m0.VectorNorm1(mResult, true);
///	CPUDoubleMatrix m2(1, 3);
///	m2(0, 0) = 5;
///	m2(0, 1) = 7;
///	m2(0, 2) = 9;
...
///}
///
///TEST_F(CPUMatrixTests, SetValues)
///{
///	RandomSeedFixture rsf;
///	CPUDoubleMatrix m0(3, 3);
///	m0(0, 0) = 10;
///	m0(1, 1) = 10;
///	m0(2, 2) = 10;
///
...
///	m1(2, 1) = 6;
///
///	CPUDoubleMatrix m2 = m0.Transpose();
...
///}
///
///TEST_F(CPUMatrixTests, ColumnSlice)
///{
///	RandomSeedFixture rsf;
///	CPUDoubleMatrix m0(2, 3);
///	m0(0, 0) = 1;
...
///	for (int i = 0; i < m; i++)
///	{
///		CPUDoubleMatrix colMB = mB.GetColumnSlice(i, 1);
///		CPUDoubleMatrix colMC = mC.GetColumnSlice(i, 1);
///		CPUDoubleMatrix::MultiplyAndAdd(mA, false, colMB, false, colMC);
///	}
///	ASSERT_TRUE(mC.IsEqualTo(mD, c_epsilonFloatE4));
///}
///
///TEST_F(CPUMatrixTests, CPUKhatriRaoProduct)
///{
///	CPUDoubleMatrix mA(3, 4);
///	mA(0, 0) = 0.8147;
///	mA(0, 1) = 0.9134;
///	mA(0, 2) = 0.2785;
///	mA(0, 3) = 0.9649;
...
///}
///
///TEST_F(CPUMatrixTests, CPUAddColumnReshapeProductOf)
///{
///	CPUDoubleMatrix mA(6, 2);
///	mA(0, 0) = 0.6557;
///	mA(0, 1) = 0.7431;
///	mA(1, 0) = 0.0357;
///	mA(1, 1) = 0.3922;
...
///	mB(2, 1) = 0.3171;
///
///	CPUDoubleMatrix mD(2, 2);
///	mD(0, 0) = 0.2867;
///	mD(0, 1) = 1.2913;
///	mD(1, 0) = 0.1266;
///	mD(1, 1) = 0.4520;
///
///	CPUDoubleMatrix mE(2, 2);
///	mE(0, 0) = 0.2657;
///	mE(0, 1) = 1.0923;
///	mE(1, 0) = 0.3636;
///	mE(1, 1) = 0.6416;
///
///	CPUDoubleMatrix mC(2, 2);
///	mC.SetValue(0);
...
///}
///
///TEST_F(CPUMatrixTests, RowSliceAndStack)
///{
///	CPUDoubleMatrix m0(5, 3);
///	m0(0, 0) = 1;
///	m0(0, 1) = 6;
///	m0(0, 2) = 11;
///	m0(1, 0) = 2;
...
///}
///
///TEST_F(CPUMatrixTests, CPUAssignRepeatOf)
///{
///	CPUDoubleMatrix m0(2, 3);
///	m0(0, 0) = 1;
///	m0(0, 1) = 6;
...
///}
///
///TEST_F(CPUMatrixTests, SeedingFloat)
///{
///	const float low = 0;
///	const float high = 1;
...
///}
///
///TEST_F(CPUMatrixTests, SeedingDouble)
///{
///	const double low = 0;
///	const double high = 1;
///	const unsigned long seed = 4711;
...
///}
///
///TEST_F(CPUMatrixTests, AdamVarEpsilon)
///{
///	CPUMatrix<double> adamMatrix;
///	CPUMatrix<double> gradients(2, 1);
///	CPUMatrix<double> parameters(2, 1);
...
///}
///
///TEST_F(CPUMatrixTests, OneHot)
///{
///	const size_t num_class = 6;
///
///	CPUDoubleMatrix m0(2, 2);
///	m0(0, 0) = 1;
///	m0(0, 1) = 2;
///	m0(1, 0) = 3;
///	m0(1, 1) = 4;
///
///	CPUDoubleMatrix expect(12, 2);
///	expect(1, 0) = 1;
///	expect(9, 0) = 1;
///	expect(2, 1) = 1;
///	expect(10, 1) = 1;
...
///
///	CPUDoubleMatrix dirtyMatrix(2, 2);
///	dirtyMatrix(0, 0) = 1;
///	dirtyMatrix(0, 1) = -1;
///	dirtyMatrix(1, 0) = 7;
///	dirtyMatrix(1, 1) = 4;
///
///	CPUDoubleMatrix dirtyExpect(12, 2);
///	dirtyExpect(1, 0) = 1;
///	dirtyExpect(9, 0) = 0;
///	dirtyExpect(2, 1) = 0;
///	dirtyExpect(10, 1) = 1;
///
///	CPUDoubleMatrix dirty_m;
...
///}
///
///TEST_F(CPUMatrixTests, ScatterToIndices)
///{
...
///	m0(1, 1) = 4;
///
///	CPUDoubleMatrix m1(row_elements, 6);
///	m1(0, 1) = m1(1, 1) = 4;
///	m1(0, 2) = m1(1, 2) = 3;
///	m1(0, 3) = m1(1, 3) = 2;
///	m1(0, 4) = m1(1, 4) = 1;
///
///	CPUDoubleMatrix m3(4, 2);
///	m3(0, 0) = 1;
///	m3(1, 0) = 2;
///	m3(2, 0) = 3;
///	m3(3, 0) = 4;
...
///
///	CPUDoubleMatrix expect(row_elements, 6);
///	expect(0, 1) = 5;
///	expect(1, 1) = 6;
///	expect(0, 2) = 11;
///	expect(1, 2) = 13;
...
///}
///
///TEST_F(CPUMatrixTests, GatherFromTarget)
///{
///	const size_t row_elements = 2;
///
///	CPUDoubleMatrix m0(2, 2);
